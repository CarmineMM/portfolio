    ...
    async findAll(): Promise<ProjectRecord[]> {
        return Promise.resolve([
            ...
            },
            {
                id: '7',
                name: {
                    es: 'ACE Circulars — Sitio Web Corporativo',
                    en: 'ACE Circulars — Corporate Website',
                },
                description: {
                    es: 'Sitio web corporativo para <b>AdCarriers Enterprises</b>, empresa de distribución de marketing directo puerta a puerta en NYC, NJ y CT. Desarrollado con arquitectura <b>Headless CMS</b> usando <b>WordPress</b> como backend de contenido y <b>Next.js</b> con <b>React</b> en el frontend, con animaciones GSAP para una experiencia visual de alto impacto. El proyecto incluyó migración de datos desde el sitio anterior y un sistema de gestión de contenido completamente personalizado para el equipo editorial del cliente.',
                    en: 'Corporate website for <b>AdCarriers Enterprises</b>, a door-to-door direct marketing distribution company operating across NYC, NJ and CT. Built with a <b>Headless CMS</b> architecture using <b>WordPress</b> as the content backend and <b>Next.js</b> with <b>React</b> on the frontend, with GSAP animations for a high-impact visual experience. The project included data migration from the previous site and a fully customized content management system for the client\'s editorial team.',
                },
                url: 'https://acecirculars.com',
                images: [
                    '/assets/projects/ace/ace-1.png',
                    '/assets/projects/ace/ace-2.png',
                    '/assets/projects/ace/ace-3.png',
                ],
                technologies: [
                    technologies.nextjs,
                    technologies.react,
